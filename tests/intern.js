...
define({
	...
	loaderOptions: {
		...
		packages: [
			{ name: 'app', location: 'bower_coponents/app' },
			{ name: 'dojo', location: 'bower_coponents/dojo' },
			{ name: 'dojox', location: 'bower_coponents/dojox' },
			{ name: 'util', location: 'bower_coponents/dojo-util' },
			{ name: 'dijit', location: 'bower_coponents/dijit' }
		]
	},
